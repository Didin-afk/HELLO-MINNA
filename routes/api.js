...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'HADIR_HMM') return res.json(loghandler.invalidKey)
...
router.get('/cewe/naruto', async (req, res, next) => {
   var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'HADIR_HMM')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/zeeoneofc/Asupan/main/cecan/naruto.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kisahmuslim', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'HADIR_HMM')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Didin-afk/botMd/main/kisahmuslim.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakkimia', async (req, res, next) => {
	...
	if(apikeyInput != 'HADIR_HMM') return res.json(loghandler.invalidKey)
       ...
       fetch(encodeURI(`https://docs-jojo.herokuapp.com/api/tebak-unsur-kimia`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
